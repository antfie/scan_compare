...
func main() {
	...
	vlabel := flag.String("vlabel", "default", "Veracode credentials label - See https://docs.veracode.com/r/c_httpie_tool")
	...
	var apiId, apiKey = getCredentials(*vid, *vkey, *vlabel)
